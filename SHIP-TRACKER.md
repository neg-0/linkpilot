...
### 🔧 Code & Infrastructure
- [x] MVP scaffold (crawler, embeddings, analyzer)
- [x] Gemini embeddings with provider abstraction
- [x] CSV export endpoint
- [ ] UI polish (loading states, mobile, a11y)
- [ ] Stripe checkout integration
- [ ] Usage tracking / rate limiting
- [ ] Email capture (waitlist before launch)
...
- [ ] SSL verified
- [ ] Analytics added (Plausible/Umami)
- [ ] Error tracking (Sentry)

## Pricing
| Tier | Pages | Price | Stripe Price ID |
|------|-------|-------|-----------------|
| Starter | 100 | $19/mo | TBD |
| Growth | 500 | $49/mo | TBD |
| Pro | 2000 | $99/mo | TBD |
