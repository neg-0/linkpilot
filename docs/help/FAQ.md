...
- **Better suggestions**: Users report more relevant, less "spammy" results

### What's an "orphan page"?
An orphan page has zero or very few internal links pointing to it. Search engines have trouble discovering these pages, which hurts your SEO.
...
- Look in your `robots.txt` file

Most CMS platforms (WordPress, Webflow, etc.) generate sitemaps automatically.
...
### Can I analyze competitor sites?
Technically yes, but the suggestions are most useful when you can actually implement the links on your own site.
...
### Is there an API?
Yes! Pro plan includes API access. See our [API documentation](/docs/api).
